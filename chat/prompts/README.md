...
- **2. test_idea** — `invention_loop`
  ...
  - round_2
    ...
    - `2_gen_plan/` — 2 task(s)
      - `chat/prompts/2_test_idea/round_2/2_gen_plan/gen_plan_experiment_1.md` — 10 prompts
      - `chat/prompts/2_test_idea/round_2/2_gen_plan/gen_plan_research_1.md` — 7 prompts
    - `3_gen_art/` — 2 task(s)
      - `chat/prompts/2_test_idea/round_2/3_gen_art/gen_art_experiment_1.md` — 36 prompts
