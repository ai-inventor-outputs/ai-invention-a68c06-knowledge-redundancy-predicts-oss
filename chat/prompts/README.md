...
- **1. create_idea** — `hypo_loop`
  - round_1
    - `chat/prompts/1_create_idea/round_1/1_review_hypo.md` — 1 prompt
- **2. test_idea** — `invention_loop`
  - round_1
    - `chat/prompts/2_test_idea/round_1/1_gen_strat.md` — 2 prompts
    - `2_gen_plan/` — 3 task(s)
      - `chat/prompts/2_test_idea/round_1/2_gen_plan/gen_plan_dataset_1.md` — 21 prompts
      - `chat/prompts/2_test_idea/round_1/2_gen_plan/gen_plan_research_1.md` — 20 prompts
      - `chat/prompts/2_test_idea/round_1/2_gen_plan/gen_plan_research_2.md` — 6 prompts
    - `3_gen_art/` — 3 task(s)
      - `chat/prompts/2_test_idea/round_1/3_gen_art/gen_art_dataset_1.md` — 24 prompts
      - `chat/prompts/2_test_idea/round_1/3_gen_art/gen_art_research_1.md` — 11 prompts
      - `chat/prompts/2_test_idea/round_1/3_gen_art/gen_art_research_2.md` — 9 prompts
  ...
  - round_2
    ...
    - `2_gen_plan/` — 3 task(s)
      - `chat/prompts/2_test_idea/round_2/2_gen_plan/gen_plan_dataset_1.md` — 9 prompts
      - `chat/prompts/2_test_idea/round_2/2_gen_plan/gen_plan_experiment_1.md` — 14 prompts
    ...
    - `3_gen_art/` — 3 task(s)
      ...
      - `chat/prompts/2_test_idea/round_2/3_gen_art/gen_art_experiment_1.md` — 22 prompts
...
- **3. report_results** — `gen_paper_repo`
  ...
  - `2_gen_demo_art/` — 3 task(s)
    - `chat/prompts/3_report_results/2_gen_demo_art/gen_demo_art_dataset_1.md` — 8 prompts
    - `chat/prompts/3_report_results/2_gen_demo_art/gen_demo_art_dataset_2.md` — 8 prompts
    - `chat/prompts/3_report_results/2_gen_demo_art/gen_demo_art_experiment_1.md` — 9 prompts
